...
- Primary Color: `#70FCF8`
- Secondary Color: `#FCC4BE`
- `#FCC4BE` は淡い色のため，文字・アイコン・スキップ状態には濃い派生色 `#A33A48` を使ってコントラストを確保する
- `#70FCF8` は明るい色のため，文字・アイコン・状態表示には濃い派生色 `#007C7A` を使ってコントラストを確保する
- 猫のキャラクターを案内役として使い，医療アプリとしての読みやすさを保ちながら可愛い印象にする
- 猫キャラクター画像は `assets/pillneko/` の素材を使用し，アプリ内では Asset Catalog に取り込んで表示する
